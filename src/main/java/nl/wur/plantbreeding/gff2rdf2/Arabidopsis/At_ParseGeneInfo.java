...
//                    }
//                    gene.addPosition(content[0], content[1]);
//                } else if (strline.startsWith("locus_tag")) {
//                    String[] content = strline.split("\t");
//                    String locus = content[content.length - 1];
//                    gene.setLocus(locus);
//                } else if (strline.startsWith("gene\t")) {
//                    String[] content = strline.split("\t");
//                    String name = content[content.length - 1];
//                    gene.setName(name);
//                } else if (strline.startsWith("function\t")) {
//                    String[] content = strline.split("\t");
//                    String function = content[content.length - 1];
//                    gene.setFunction(function);
//                } else if (strline.startsWith("go_")) {
//                    Pattern myPattern = Pattern.compile("GO:\\d+");
//                    Matcher match = myPattern.matcher(strline);
//                    while (match.find()) {
//                        gene.addGoTerm(match.group());
//                    }
//                }
